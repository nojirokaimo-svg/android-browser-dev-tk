...
Build #160 は2026年9月25日に #157 の完全一致キャッシュから完成し、Android v2 署名を確認しました。APKの SHA-256 は `b364caef95756437a01610615e366599391a7dfca16273fa17f7d60f52c10d29` です。Titanium準備後の実ソースで未確定だった3ファイルのハッシュを確定しました。最終ビルドは #160 の完成キャッシュを使い、manifest 全件の適用後ハッシュを検査します。節電率と全画面への配色反映は実機未計測です。
